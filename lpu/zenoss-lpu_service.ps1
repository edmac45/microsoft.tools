...
## $services = get-wmiobject -query get-wmiobject -query "Select * from Win32_Service" | Where-Object {$_.name -like "*sql*"}
$services = get-wmiobject -query "Select * from Win32_Service" | Where-Object {$_.name -like "DPS"} 
